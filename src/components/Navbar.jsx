            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                <div className="flex items-center justify-between h-20">
                    ...
                    <nav className="flex grow sm:hidden justify-end" onClick={()=>setOpen(!isOpen)}>
                        ...
                        <div className={`${isOpen?  'translate-y-0' : '-translate-y-[60rem]'} duration-1000 transition-all ease-in-out shadow w-screen h-screen fixed left-0 top-0 z-10 backdrop-blur-md`}>
                            <ul className={` flex grow justify-end flex-wrap items-center gap-4 flex-col w-[50%] fixed top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] p-4 pb-8 bg-cyan z-50`}>
